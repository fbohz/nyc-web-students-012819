...
* Create:
  - POST `https://safe-river-70277.herokuapp.com/encouraging_notes`
  - params {"message": "An encouraging message!", "username": "name"}
* Update
  - PATCH `https://safe-river-70277.herokuapp.com/encouraging_notes/:id`
  - params {"message": "A new, but still encouraging message!", "username": "a new name"}
